...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(appTitle) =>
      "Ниже представлен список всех ресурсов, которые напрямую используются в ${appTitle}. Некоторые библиотеки, используемые в ${appTitle} могут содержать и/или использовать другие ресурсы. Нажмите на название ресурса, чтобы перейти на его сайт. Нажмите на название лицензии, чтобы прочитать её текст в интернете.";
